  ...
  return new Response(
    JSON.stringify({
      ...
      env: {
        ...
        MEAI_API_KEY: flag("MEAI_API_KEY") || flag("GAFCORE_MEAI_API_KEY"),
        GPTPRO4ALL_API_KEY: flag("GPTPRO4ALL_API_KEY"),
        OPENROUTER_API_KEY: flag("OPENROUTER_API_KEY"),
        GEMINI_API_KEY: flag("GEMINI_API_KEY") || flag("GOOGLE_AI_API_KEY"),
